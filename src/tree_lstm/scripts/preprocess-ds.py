...
if __name__ == '__main__':
    ...
    dev_dir = os.path.join(ds_dir, 'dev')
    ...
    # get vocabulary
    build_vocab(
        glob.glob(os.path.join(ds_dir, '*/*.toks')),
        os.path.join(ds_dir, 'vocab.txt'))
    build_vocab(
        glob.glob(os.path.join(ds_dir, '*/*.toks')),
        os.path.join(ds_dir, 'vocab-cased.txt'),
        lowercase=False)
